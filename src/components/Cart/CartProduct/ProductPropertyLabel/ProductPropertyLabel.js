...
export default class ProductPropertyLabel extends PureComponent<Props, void> {
  props: Props;
  ...
  render() {
    ...
    return (
      <div className="form-group row">
        <div className={classNames("col-xs-6", "col-md-5", "col-lg-4")}>
          {" "}
          {name}
        </div>
        <div className={classNames("col-xs-6", "col-md-7", "col-lg-8")}>
          {" "}
          {value}
        </div>
      </div>
