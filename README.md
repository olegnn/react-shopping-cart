...
- Create getLocalization function with bound localization using **defaultLocalization** object and **getLocalization**, **getDefaultLocalization** functions from _cartLocalization_ module, pass it as prop to the cart's components
...
Or you could use **getDefaultLocalization** function from _cartLocalization_:
...
<Cart getLocalization={getDefaultLocalization("cart", "en", localization)} />;
```

Example usage of **getLocalization** function from _cartLocalization_:
...
<Cart
  getLocalization={(...args) =>
    getLocalization(mergedEnCartLocalization, "en", ...args)
  }
/>;
```
...
- **cart:**
  ...
  - _{
    ...
    - remove
    - **_your currency_**
    - **_your product's name_**

  - _{name, value, localizedName, localizedValue,}_
    - productPropertyLabel
    - productPropertyValue
    - **_your product's property name_**
    - **_your product's property value (if string of course)_**
